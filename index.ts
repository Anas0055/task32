...
let currentUsers: string[] = ["John", "Alice", "Bob", "Eva", "admin"];

// List of new usernames
let newUsers: string[] = ["Alice", "Dave", "Bob", "Frank", "Mia"];
...
for (let newUser of newUsers) {
    ...
    if (currentUsers.map(user => user.toLowerCase()).includes(lowercaseNewUser)) {
